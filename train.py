...
# regex = r'^[a-z ]+$' #纯英文
regex = r'^[\u4e00-\u9fa5_a-zA-Z0-9]+$' # 中英文
alphabet = u'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789京沪津渝冀晋蒙辽吉黑苏浙皖闽赣鲁豫鄂湘粤桂琼川贵云藏陕甘青宁新 '
...
def paint_text(text, w, h, rotate=False, ud=False, multi_fonts=False):
    ...
    with cairo.Context(surface) as context:
        ...
        # else:
        #     context.select_font_face('AR PL UKai CN',
        #                              cairo.FONT_SLANT_NORMAL,
...
class VizCallback(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        myfont = FontProperties(fname='/usr/share/fonts/truetype/ukai.ttc')
        ...
        for i in range(self.num_display_words):
            ...
            plt.xlabel(
                'Truth = \'%s\'\nDecoded = \'%s\'' %
                (word_batch['source_str'][i], res[i]),fontproperties=myfont)
        fig = plt.gcf()
